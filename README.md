...
[![Build status](https://ci.appveyor.com/api/projects/status/d38gku3x78fvifnr/branch/master?svg=true)](https://ci.appveyor.com/project/ja-thomas/autoxgboost/branch/master)
