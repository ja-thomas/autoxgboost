...
test_that("classif.autoxgboost works", {
  ...
  lrn = makeLearner("classif.autoxgboost", control = ctrl, mbo.learner = mbo.learner, predict.type = "response", nthread = 1)
  ...
  #prob + binary
  lrn = makeLearner("classif.autoxgboost", control = ctrl, mbo.learner = mbo.learner, predict.type = "prob", nthread = 1)
  res = holdout(lrn, sonar.task)
...
test_that("regr.autoxgboost works", {
  lrn = makeLearner("regr.autoxgboost", control = ctrl, mbo.learner = mbo.learner, nthread = 1)
